 ...
 * Bdcc_Status Class
 *
 * This class contains constants for status codes used in Bradley Dyer projects
...
Class Status
{
   ...
   /**
     ...
     *
     * @param   integer     $statusCode     Status code to test
     * @return  boolean
     */
    ...
    /**
     * Check if status code belongs Success response group
     *
     * @param   integer     $statusCode     Status code to test
     * @return  boolean
     */
    ...
    /**
     * Check if status code belongs Redirection response group
     *
     * @param   integer     $statusCode     Status code to test
     * @return  boolean
     */
    ...
    /**
     * Check if status code belongs Client Error response group
     *
     * @param   integer     $statusCode     Status code to test
     * @return  boolean
     */
    ...
    /**
     * Check if status code belongs Server Error response group
     *
     * @param   integer     $statusCode     Status code to test
     * @return  boolean
     */
